...
public_users.get("/", (req, res) => books.length === 0 ? pretty(res, {message: "No books available"}, 404) : pretty(res, books));
...
public_users.get("/review/:isbn", (req, res) => {
  ...
  return book_id ? pretty(res, book[book_id].reviews) : pretty(res, {message: "Book not found"}, 404);
});
